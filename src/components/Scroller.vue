<script>
import { XHeader,Scroller, Divider, Spinner, XButton, Group, Cell, LoadMore } from 'vux'
...
<template>
  <div>
    <!-- 头部导航栏 -->
    <div class="vux_demo">
      <x-header>Scroller demo</x-header>
    </div>
    <group  style="margin-top:50px;">
      <cell is-link title="pullup" >Pullup</cell>
      <cell is-link title="pulldown" >Pulldown</cell>
      <cell is-link title="pulldownpullup" >PulldownPullup</cell>
    </group> 
